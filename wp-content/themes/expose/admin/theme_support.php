...
if(!( function_exists('ebor_framework_add_theme_support') )){
	function ebor_framework_add_theme_support() {
		 ...
		 */
		add_image_size( 'blog', 530, 9999, false );
		add_image_size( 'grid', 500, 380, true );
		add_image_size( 'team', 500, 500, true );
		add_image_size( 'masonry', 760, 9999, false );
		 ...
		 */
		load_theme_textdomain('expose', EBOR_THEME_DIRECTORY . 'languages');
